...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'nvim-colorizer.lua', 'todo-comments.nvim', 'nvim-lspconfig', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]
