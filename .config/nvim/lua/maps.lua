...
map("n", "<leader>ld", ":lua require('goto-preview').goto_preview_definition()<CR>", lsp_opts)
map("n", "<leader>k", ":lua vim.lsp.buf.hover()<CR>", lsp_opts)
map("n", "<leader>li", ":lua require('goto-preview').goto_preview_implementation()<CR>", lsp_opts)
map("n", "<leader>lg", ":lua require('goto-preview').close_all_win()<CR>", lsp_opts)
...
map("n", "<leader>lc", ":CodeActionMenu<CR>", lsp_opts)
map("n", "<leader>ls", ":SymbolsOutline<CR>", lsp_opts)
